...
function matchAlias(format, node, delta) {
  return delta.compose(new _quillDelta2.default().retain(delta.length(), _defineProperty({}, format, true), true));
}
...
function matchAttributor(node, delta) {
  ...
  if (Object.keys(formats).length > 0) {
    delta = delta.compose(new _quillDelta2.default().retain(delta.length(), formats, true));
  }
  return delta;
}
...
describe('Quill', function () {
  ...
  describe('construction', function () {
    ...
    it('nested props', function () {
      var quill = this.initialize(_quill2.default, '<p><span style="color: #000;">black <span style="color: #F00;">red</span> black</span></p>');
